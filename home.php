<?php 
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/projects/twitter/controllers/postController.php');
    ...
    if ($userProfilePic == "") {
        $userProfilePic = "/projects/twitter/img/default_avatar.png";
    }
...
<html lang="en">
    ...
    <body>
        ...
        <section class="user-feed-container">
                ...
                <div class="feed-tweet">
                    <div class="feed-tweet-top">
                        <div class="feed-tweet-profile-pic">
                            <img src="<?php echo $userProfilePic ?>" alt='Profile Image'>
                        </div>
                        <textarea name="new-tweet-input" class="feed-tweet-text" maxlength="190" placeholder="What's happening?"></textarea>
                    </div>

                    <div class="feed-tweet-media-append">
                        <img id="display-user-media" src="" alt="Post Image">
                    </div>
                    ...
                    <div class="feed-tweet-bottom">
                        ...
                        <button class="feed-tweet-btn" type="submit" name="new-tweet-btn">Tweet</button> 
                    </div>
                </div>
            </form>
        ...
        <script src="/projects/twitter/js/app.js?<?php echo bin2hex(random_bytes(6)) ?>"></script>
